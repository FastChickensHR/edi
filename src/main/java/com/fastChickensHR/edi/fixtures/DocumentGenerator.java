...
/**
 * Fluent generator that assembles a complete {@link x834Document} containing
 ...
 *
 * <pre>{@code
 * x834Document doc = X834Fixtures.seeded(1L)
 *         .document()
 *         .withEmployees(100)
 *         .build();
...
public final class DocumentGenerator {
    ...
    DocumentGenerator(X834Fixtures parent) {
        this.parent = parent;
    ...
    /** Builds a complete {@link x834Document} populated with realistic data. */
