...
/**
 * Code values for the X12 Security Level Code (data element 1204), a shared ASC X12 code set
 * describing the sensitivity or confidentiality classification of information. Exposed by the X12
 * 834 (005010X220A1) library as a reusable code list.
 *
...
public enum SecurityLevelCode implements EdiCodeEnum {
  ...
  /**
   * Gets a SecurityLevelCode instance from any input string. Matches against codes, names,
