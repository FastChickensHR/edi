...
/**
 * Represents the SE (Transaction Set Trailer) segment in the X12 834 (005010X220A1) format.
 *
 * <p>This segment closes a transaction set opened by an {@code STSegment} and reconciles it via the
 * count of included segments and the matching control number.
 *
 * <p>Element/position map:
 *
 * <ul>
 *   <li>SE01 = number of segments included in the transaction set (inclusive of ST and SE)
 *   <li>SE02 = transaction set control number (matches the ST02 of the paired ST segment)
 * </ul>
 */
@Getter
abstract class SESegment extends Segment {
