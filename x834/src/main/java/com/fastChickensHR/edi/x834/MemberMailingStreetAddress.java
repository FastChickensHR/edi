...
/**
 * Represents the member's mailing street address in Loop 2100C. This extends the N3 segment to
 * provide address information for a member.
 */
@Getter
class MemberMailingStreetAddress extends N3Segment {
  ...
  protected void validate() throws ValidationException {
    if (n301 == null || n301.trim().isEmpty()) {
      throw new ValidationException(
          "Address Line 1 (N301) is required for Member Mailing Street Address");
    }
