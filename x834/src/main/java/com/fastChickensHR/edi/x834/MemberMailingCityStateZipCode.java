...
/**
 * Represents a Member Mailing City, State, and Zip Code (N4) segment in Loop 2100C of the X834
 * format. Implements city name (N401), state/province code (N402), and postal code (N403).
 */
@Getter
class MemberMailingCityStateZipCode extends N4Segment {
