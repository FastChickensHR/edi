 ...
 * (005010X220A1). The BGN follows the transaction set header (ST) in the header portion of the 834
 * and provides transaction set purpose and control information.
 */
@Getter
class BeginningSegment extends BGNSegment {
  ...
  public static class Builder extends BGNSegment.AbstractBuilder<BeginningSegment.Builder> {
    ...
    /**
     * Creates a builder seeded with the default purpose code (BGN01=00) and the context's formatted
     * document date as the transaction set reference date (BGN03).
     *
