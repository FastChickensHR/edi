...
/**
 * Represents the LS (Loop Header) segment in the X12 834 (005010X220A1) Benefit Enrollment and
 * Maintenance transaction.
 *
 * <p>LS opens a bounded loop and is closed by a matching {@link LESegment}; both carry the same
 * loop identifier code so the pair brackets the enclosed occurrences. In the 834 this brackets Loop
 * 2700 (Member Reporting Categories).
 *
 * <p>Element/position map:
 *
 * <ul>
 *   <li>LS01 = loop identifier code — the loop this header opens (e.g. "2700")
 * </ul>
 */
@Getter
class LSSegment extends Segment {
