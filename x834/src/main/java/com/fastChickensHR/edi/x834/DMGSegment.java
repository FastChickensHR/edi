...
/**
 * Represents the DMG (Demographic Information) segment in the X12 834 (005010X220A1) Benefit
 * Enrollment and Maintenance transaction.
 *
 * <p>This segment carries demographic information about a member — birth date, gender, marital
 * status, and related codes.
 *
 * <p>Element/position map (meanings derived from the accessor names on this class):
 *
 * <ul>
 *   <li>DMG01 = date/time period format qualifier
 *   <li>DMG02 = birth date (formatted per DMG01)
 *   <li>DMG03 = gender code (commonly M = Male, F = Female)
 *   <li>DMG04 = marital status code
 *   <li>DMG05 = race or ethnicity code
 *   <li>DMG06 = citizenship status code
 *   <li>DMG07 = country code
 *   <li>DMG08 = basis of verification code
 *   <li>DMG09 = quantity
 *   <li>DMG10 = code list qualifier code
 *   <li>DMG11 = industry code
 * </ul>
 */
@Getter
abstract class DMGSegment extends Segment {
  ...
  /**
   * Gets the gender code. Common values: M (Male), F (Female)
   *
   * @return gender code
   */
