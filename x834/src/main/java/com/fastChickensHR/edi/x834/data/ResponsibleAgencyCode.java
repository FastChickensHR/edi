...
/**
 * Code values for the Responsible Agency Code (GS07, X12 data element 455) in the Functional Group
 * Header (GS). Names the body responsible for the standard used in the functional group; X12 834
 * groups (005010X220A1) use {@link #ASC_X12} ("X").
 *
...
public enum ResponsibleAgencyCode implements EdiCodeEnum {
  ...
  /**
   * Gets a ResponsibleAgencyCode instance from any input string. Matches against codes, names,
