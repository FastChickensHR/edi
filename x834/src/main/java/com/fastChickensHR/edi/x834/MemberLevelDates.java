...
/**
 * Represents a Member Level Date segment in the 834 EDI format. This segment is used to indicate
 * various date values associated with a member in Loop 2000.
 */
class MemberLevelDates extends DTPSegment {
