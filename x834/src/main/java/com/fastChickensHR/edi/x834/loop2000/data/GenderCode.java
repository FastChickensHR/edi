...
/**
 * Enumeration representing Gender Codes used in the EDI 834 Health Insurance Enrollment
 * transaction, specifically in INS17 segment.
 */
@Getter
public enum GenderCode implements EdiCodeEnum {
  ...
  /**
   * Gets a GenderCode instance from any input string. Matches against codes, names, descriptions,
