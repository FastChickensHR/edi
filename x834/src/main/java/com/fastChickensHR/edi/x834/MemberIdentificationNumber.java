 ...
 *
 * <p>Renders {@code REF*DX*<identification number>}: REF01 is fixed to the qualifier {@code DX} and
 * REF02 carries the member's identification number.
 */
class MemberIdentificationNumber extends RefSegment {
  /**
   * REF01 qualifier {@code DX} — the fixed default reference qualifier for this
   * member-identification REF segment.
   */
  public static final String DEFAULT_ENTITY_IDENTIFIER_CODE = "DX";

  private MemberIdentificationNumber(MemberIdentificationNumber.Builder builder)
  ...
  /**
   * Builds the member-identification REF, defaulting REF01 to {@link
   * MemberIdentificationNumber#DEFAULT_ENTITY_IDENTIFIER_CODE}.
   */
  @Accessors(chain = true)
  public static class Builder
      extends RefSegment.AbstractBuilder<MemberIdentificationNumber.Builder> {
    public Builder() {
