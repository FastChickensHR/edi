 ...
 * (005010X220A1).
 *
 * <p>{@link #payerResponsibility} says where that plan sits in the payment order and {@link
 * #benefitsCoordination} whether benefits are coordinated at all; together they are the carrier's
 * answer to "does this person have other coverage, and does it pay first?". The rest is detail
 * about that plan: its {@link #policyIdentifier}, the {@link #groupNumber} it is held under, the
 * dates the coordination is {@link #beginDate in force}, and the {@link #relatedEntityName name} of
 * the plan itself.
 *
 * <p>The two shapes profiled carriers ask for sit at opposite ends of the range. BCBSM's Medicare
...
public class CoordinationOfBenefits {
   ...
   */
  public CoordinationOfBenefits(
      PayerResponsibilitySequenceCode payerResponsibility,
