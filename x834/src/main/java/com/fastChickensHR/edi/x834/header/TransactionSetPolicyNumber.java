...
/**
 * Master policy number reference (REF*38) in the header portion of the X12 834 (005010X220A1). This
 * segment uses the REF segment format with the {@code "38"} qualifier for the master policy number.
 */
@Getter
class TransactionSetPolicyNumber extends RefSegment {
  ...
  private static final String DEFAULT_REFERENCE_IDENTIFICATION_QUALIFIER = "38";
  ...
  /**
   * Builder for the TransactionSetPolicyNumber. Seeds the master-policy-number qualifier
   * (REF01=38).
   */
  public static class Builder
      extends RefSegment.AbstractBuilder<TransactionSetPolicyNumber.Builder> {
