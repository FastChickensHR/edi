...
/**
 * Represents the IEA (Interchange Control Trailer) segment in the X12 834 (005010X220A1) format.
 *
 * <p>This segment closes the interchange envelope opened by an {@code ISASegment} and reconciles it
 * via the count of functional groups and the matching interchange control number.
 *
 * <p>Element/position map:
 *
 * <ul>
 *   <li>IEA01 = number of included functional groups (required)
 *   <li>IEA02 = interchange control number (required; matches the ISA13 of the paired ISA)
 * </ul>
 */
@Getter
abstract class IEASegment extends Segment {
