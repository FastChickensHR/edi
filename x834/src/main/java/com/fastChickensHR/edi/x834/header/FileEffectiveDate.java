 ...
 * <p>
 * Produces the DTP segment carrying the master effective date for the file:
 * DTP01 = date/time qualifier (defaults to {@code 007}, Effective), DTP02 = the
 * context's date format, DTP03 = the formatted date value.
 */
