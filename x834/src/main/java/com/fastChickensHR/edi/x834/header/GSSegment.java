...
/**
 * Represents the GS (Functional Group Header) segment in the X12 834 (005010X220A1) format.
 *
 * <p>This segment opens a functional group inside an interchange and identifies the business
 * function, trading partners, timestamp, control number, and standards version. It is closed by a
 * matching {@code GESegment}.
 *
 * <p>Element/position map:
 *
 * <ul>
 *   <li>GS01 = functional identifier code (the group's business function)
 *   <li>GS02 = application sender's code (2–15 characters)
 *   <li>GS03 = application receiver's code (2–15 characters)
 *   <li>GS04 = creation date (YYYYMMDD)
 *   <li>GS05 = creation time (HHMM)
 *   <li>GS06 = group control number (max 9 characters; matched by GE02)
 *   <li>GS07 = responsible agency code
 *   <li>GS08 = version / release / industry identifier code
 * </ul>
 */
@Getter
abstract class GSSegment extends Segment {
  ...
  private void validateRequiredFields() throws ValidationException {
    ...
    if (gs02.length() < 2 || gs02.length() > 15) {
      throw new ValidationException(
          "Application Sender's Code (GS02) must be between 2 and 15 characters");
    }
    ...
    if (gs03.length() < 2 || gs03.length() > 15) {
      throw new ValidationException(
          "Application Receiver's Code (GS03) must be between 2 and 15 characters");
    }
  ...
  public abstract static class AbstractBuilder<T extends AbstractBuilder<T>> {
    ...
    public T setGs04(LocalDateTime value, DateFormat dateFormat) {
      this.gs04 = dateFormat.format(value);
      return self();
    }
    ...
    public T setGs05(LocalDateTime value, TimeFormat timeFormat) {
      this.gs05 = timeFormat.format(value);
      return self();
    }
