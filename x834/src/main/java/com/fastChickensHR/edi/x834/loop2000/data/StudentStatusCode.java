...
/**
 * Enumeration representing Student Status Codes (X12 element 1220) emitted at the INS09 field of
 * the EDI 834 transaction.
 *
 * <p>Element 1220 defines exactly three codes: {@code F}, {@code N}, {@code P}. The former list
 * carried five invented codes ({@code C}, {@code G}, {@code B}, {@code L}, {@code U}) that do not
 * exist in element 1220 and have been removed.
 */
@Getter
public enum StudentStatusCode implements EdiCodeEnum {
  ...
  /**
   * Gets a StudentStatusCode instance from any input string. Matches against codes, names,
