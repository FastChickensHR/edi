...
/**
 * Represents the LX (Assigned Number) segment in the X12 834 (005010X220A1) Benefit Enrollment and
 * Maintenance transaction.
 *
 * <p>LX carries a sequential number that distinguishes one occurrence of a repeating loop from the
 * next. In the 834 it opens each occurrence of Loop 2710 within the Member Reporting Categories
 * block (Loop 2700), so the number is assigned at render time over the occurrences actually
 * emitted.
 *
 * <p>Element/position map:
 *
 * <ul>
 *   <li>LX01 = assigned number — a positive sequential counter (max 6 digits)
 * </ul>
 */
@Getter
