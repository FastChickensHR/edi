...
/**
 * Code values for the X12 Transaction Type Code (data element 640), which characterizes the purpose
 * or content of a transaction set. In the X12 834 (005010X220A1) it appears as BGN08 to
 * distinguish, for example, a new initial group enrollment.
 *
...
public enum TransactionTypeCode implements EdiCodeEnum {
  ...
  /**
   * Gets a TransactionTypeCode instance from any input string. Matches against codes, names,
