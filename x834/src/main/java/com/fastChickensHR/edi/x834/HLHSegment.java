 ...
 *
 * <p>The segment carries the member's health-related status in Loop 2100A — chiefly tobacco and
 ...
 *
 * <ul>
 *   <li>HLH01 = health-related code (1212)
 *   <li>HLH02 = height (65, R 1/8)
 *   <li>HLH03 = current weight (81, R 1/10)
 *   <li>HLH04 = previous weight (81, R 1/10)
 *   <li>HLH05 = description — the reason for a change in weight (352, AN 1/80)
 * </ul>
 *
 ...
 *
 * <p>Every element is optional in X12, but a segment carrying none of them says nothing, so an
 * empty HLH is rejected rather than emitted as a bare {@code HLH~}.
 */
@Getter
abstract class HLHSegment extends Segment {
  ...
  private void validate() throws ValidationException {
    if (hlh01 == null && isBlank(hlh02) && isBlank(hlh03) && isBlank(hlh04) && isBlank(hlh05)) {
      throw new ValidationException(
          "HLH carries no health information; at least one element is required");
    }
