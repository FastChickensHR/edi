...
/**
 * Enumeration representing Date Time Qualifiers used in the DTP01 field of the EDI 834 Health
 * Coverage Dates (DTP) segment.
 */
@Getter
public enum HealthCoverageDateQualifier implements EdiCodeEnum {
  ...
  /**
   * Gets a HealthCoverageDateQualifier instance from any input string. Matches against codes,
