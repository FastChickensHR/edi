 ...
 * {@link X834Context} is injected by the document's render loop before {@link #render()}
 * is called.
 */
public abstract class Segment {
    ...
    /**
     * Sets the rendering context. Called by the document's render loop (and tests)
     * immediately before {@link #render()}; not part of the public surface.
     *
