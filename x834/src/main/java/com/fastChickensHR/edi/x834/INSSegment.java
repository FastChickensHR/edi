...
/**
 * Abstract class representing the member level detail in Loop 2000 of an EDI 834 document. This
 * segment is commonly referred to as the "INS" segment and includes information about the member
 * such as the member indicator, individual relationship code, maintenance type code, benefit status
 * code, and other member-specific information.
 */
@Getter
abstract class INSSegment extends Segment {
  ...
  public String[] getElementValues() {
    return new String[] {
      ins01 != null ? ins01.toString() : null,
      ins02 != null ? ins02.toString() : null,
      ins03 != null ? ins03.toString() : null,
      ins04 != null ? ins04.toString() : null,
      ins05 != null ? ins05.toString() : null,
      ins06 != null ? ins06.toString() : null,
      ins07 != null ? ins07.toString() : null,
      ins08 != null ? ins08.toString() : null,
      ins09 != null ? ins09.toString() : null,
      ins10 != null ? ins10.toString() : null,
      ins11,
      ins12,
      ins13 != null ? ins13.toString() : null,
    };
  }
  ...
  public static class Builder {
    ...
    /**
     * Sets the member's death date (INS12) and, unless a format qualifier (INS11) has already been
     * set, defaults INS11 to {@code D8} (CCYYMMDD) — INS11 is required whenever INS12 is present,
     * and this library renders dates as CCYYMMDD.
     */
