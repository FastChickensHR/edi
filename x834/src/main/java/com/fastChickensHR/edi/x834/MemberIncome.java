 ...
 * earns.
 *
 * <p>Nothing is defaulted. A frequency guessed wrong misstates someone's pay by an order of
 * magnitude, and a currency assumed is a currency unstated, so both are supplied by the caller or
 * absent. BCBS Kansas's use renders as {@code ICM*4*4500**DEPT42~} — a monthly wage, with the
 * department number riding ICM04.
 */
@Getter
