...
/**
 * Represents the NM1 segment for a member name in the 2100A loop. This contains identifying
 * information about the member including name and identification details.
 */
class MemberName extends NM1Segment {
  /**
   * NM101 entity identifier {@code IL} — Insured or Subscriber; the fixed default for the member
   * NM1.
   */
