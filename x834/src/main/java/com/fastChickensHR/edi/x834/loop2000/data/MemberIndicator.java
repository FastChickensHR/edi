...
/**
 * Enumeration representing the insurance status of a member in an EDI 834 transaction. Used to
 * indicate whether a member is insured or not insured.
 */
@Getter
public enum MemberIndicator implements EdiCodeEnum {
  ...
  /**
   * Gets a MemberIndicator instance from any input string. Matches against codes, names,
