...
/**
 * Enumeration representing Maintenance Type Codes used in the HD03 field of the EDI 834 Health
 * Coverage (HD) segment.
 */
@Getter
public enum MaintenanceTypeCode implements EdiCodeEnum {
  ...
  /**
   * Gets a MaintenanceTypeCode instance from any input string. Matches against codes, names,
