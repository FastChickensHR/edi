...
/**
 * Enumeration representing Medicare Plan Codes (X12 element 1218) emitted at the INS06 (composite
 * C052-01) field of the EDI 834 transaction.
 *
 * <p>The full element 1218 list. The former list carried two invented codes ({@code F} Medigap,
 * {@code N} No Medicare) and attached invented "Part C / Part D" meanings to {@code D} and {@code
 * E}: in element 1218 {@code D} is the general Medicare program code and {@code E} is "No Medicare"
 * (the declined/none code carriers default to).
 */
@Getter
public enum MedicarePlanCode implements EdiCodeEnum {
  ...
  /**
   * Gets a MedicarePlanCode instance from any input string. Matches against codes, names,
