 ...
 *
 * <p>Produces the N1 segment that identifies the plan sponsor (typically the employer) in the
 * header portion of the 834, after the transaction set header/BGN and before the payer (Loop
 * 1000B). Extends the generic {@link N1Segment}.
 */
