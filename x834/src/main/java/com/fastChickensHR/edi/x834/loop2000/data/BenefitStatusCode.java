...
/**
 * Enumeration representing Benefit Status Codes (X12 element 1216) emitted at the INS05 field of
 * the EDI 834 Member Level Detail (INS) segment.
 *
 * <p>The full element 1216 list. The former list carried two invented codes ({@code D}, {@code R}),
 * was missing {@code I} and {@code V}, and — most dangerously — labeled {@code T} as "Terminated"
 * when element 1216 defines {@code T} as TEFRA; a pick list built on the old descriptions would
 * have led an administrator to file a member into a TEFRA status while intending to terminate them.
 */
@Getter
public enum BenefitStatusCode implements EdiCodeEnum {
  ...
  /**
   * Gets a BenefitStatusCode instance from any input string. Matches against codes, names,
