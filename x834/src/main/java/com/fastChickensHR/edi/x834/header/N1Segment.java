...
/**
 * Represents the N1 (Party Identification) segment in the X12 834 (005010X220A1) Benefit Enrollment
 * and Maintenance transaction.
 *
 * <p>This segment names a party in a loop — in the 834 it is used for the plan sponsor / payer —
 * via an entity identifier, a free-form name, and an optional coded identifier.
 *
 * <p>Element/position map (meanings derived from the accessor names on this class):
 *
 * <ul>
 *   <li>N101 = entity identifier code (the party's role)
 *   <li>N102 = plan sponsor name (free-form, max 60 characters)
 *   <li>N103 = identification code qualifier (what N104 is)
 *   <li>N104 = sponsor identifier (the coded identification value)
 * </ul>
 *
 * At least one of N102 or N103 must be supplied.
 */
@Getter
abstract class N1Segment extends Segment {
  ...
  private void validate() throws ValidationException {
    ...
    if ((n102 == null || n102.isEmpty()) && n103 == null) {
      throw new ValidationException(
          "One of Plan Sponsor Name (N102) or Identification Code Qualifier (N103) are required");
    }
