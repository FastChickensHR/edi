...
/**
 * Code values for the Interchange Control Version Number (ISA12, X12 data element I11) in the
 * Interchange Control Header (ISA) of an X12 834 interchange (005010X220A1). States the ASC X12
 * version under which the interchange envelope is structured.
 *
 * <p>No default value is defined for this element. {@link #fromString(String)} resolves a value
 * from its code, publication year, enum name, or description, and throws {@link
...
public enum InterchangeControlVersionNumber implements EdiCodeEnum {
  ...
  /**
   * Gets an InterchangeControlVersionNumber instance from any input string. Matches against codes,
   * years, and common variations.
   *
