 ...
 *
 * <p>Nothing is defaulted: {@code 4} (No Disability) is a stated answer, not the absence of one,
 * and assuming it would tell a carrier something the sponsor never said.
 */
@Getter
