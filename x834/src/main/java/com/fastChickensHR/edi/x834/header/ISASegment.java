...
/**
 * Represents the ISA (Interchange Control Header) segment in the X12 834 (005010X220A1) format.
 *
 * <p>This segment opens the interchange envelope and identifies the interchange of electronic data.
 * It is a fixed-width segment: several elements have exact required lengths (ISA02 and ISA04 are 10
 * characters, ISA06 and ISA08 are 15 characters, ISA16 is 1 character). It is closed by a matching
 * {@code IEASegment}.
 *
 * <p>Element/position map:
 *
 * <ul>
 *   <li>ISA01 = authorization information qualifier
 *   <li>ISA02 = authorization information (exactly 10 characters)
 *   <li>ISA03 = security information qualifier
 *   <li>ISA04 = security information (exactly 10 characters)
 *   <li>ISA05 = interchange sender ID qualifier
 *   <li>ISA06 = interchange sender ID (exactly 15 characters; right-padded by the builder)
 *   <li>ISA07 = interchange receiver ID qualifier
 *   <li>ISA08 = interchange receiver ID (right-padded to 15 characters by the builder)
 *   <li>ISA09 = interchange date (YYMMDD)
 *   <li>ISA10 = interchange time (HHMM)
 *   <li>ISA11 = repetition / interchange control standards separator
 *   <li>ISA12 = interchange control version number
 *   <li>ISA13 = interchange control number (matched by IEA02)
 *   <li>ISA14 = acknowledgment requested flag
 *   <li>ISA15 = interchange usage indicator (e.g. test vs production)
 *   <li>ISA16 = component element separator (exactly 1 character)
 * </ul>
 */
@Getter
abstract class ISASegment extends Segment {
  ...
  private void validateRequiredFields() throws ValidationException {
    ...
    if (isa02.length() != 10) {
      throw new ValidationException(
          "ISA02 (Authorization Information) must be 10 characters in length");
    }
    if (isa03 == null) {
    ...
    if (isa16.length() != 1) {
      throw new ValidationException(
          "ISA16 (Component Element Separator) must be exactly 1 character");
    }
  }
