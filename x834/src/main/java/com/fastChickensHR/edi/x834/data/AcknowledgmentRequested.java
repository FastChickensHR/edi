 ...
 * Interchange Control Header (ISA) of an X12 834 Benefit Enrollment and Maintenance interchange
 * (005010X220A1). Indicates whether the sender requests a TA1 interchange acknowledgment.
 *
...
public enum AcknowledgmentRequested implements EdiCodeEnum {
  ...
  /**
   * Gets an AcknowledgmentRequested instance from any input string. Matches against codes, names,
