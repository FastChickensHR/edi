...
/**
 * Represents the N4 (Geographic Location) segment in the X12 834 (005010X220A1) Benefit Enrollment
 * and Maintenance transaction.
 *
 * <p>This segment carries the city/state/postal geographic information for the party named in the
 * enclosing loop.
 *
 ...
 * <ul>
 *   <li>N401 = city name
 *   <li>N402 = state or province code
 *   <li>N403 = postal code
 *   <li>N404 = country code
 *   <li>N405 = location qualifier
 *   <li>N406 = location identifier
 *   <li>N407 = country subdivision code
 * </ul>
 */
@Getter
abstract class N4Segment extends Segment {
