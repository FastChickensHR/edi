...
/**
 * Represents the LE (Loop Trailer) segment in the X12 834 (005010X220A1) Benefit Enrollment and
 * Maintenance transaction.
 *
 * <p>LE closes a bounded loop opened by a matching {@link LSSegment}; both carry the same loop
 * identifier code. In the 834 this closes Loop 2700 (Member Reporting Categories).
 *
 * <p>Element/position map:
 *
 * <ul>
 *   <li>LE01 = loop identifier code — the loop this trailer closes (e.g. "2700")
 * </ul>
 */
@Getter
class LESegment extends Segment {
