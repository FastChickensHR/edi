...
/**
 * Code values for the Interchange Usage Indicator (ISA15, X12 data element I14) in the Interchange
 * Control Header (ISA) of an X12 834 interchange (005010X220A1). Marks whether the interchange
 * carries production, test, or informational data.
 *
...
public enum InterchangeUsageIndicator implements EdiCodeEnum {
  ...
  /**
   * Gets an InterchangeUsageIndicator instance from any input string. Matches against codes, names,
