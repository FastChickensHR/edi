...
/**
 * Represents the N3 (Party Location / Address) segment in the X12 834 (005010X220A1) Benefit
 * Enrollment and Maintenance transaction.
 *
 * <p>This segment carries the street address lines for the party named in the enclosing loop.
 *
 * <p>Element/position map:
 *
 * <ul>
 *   <li>N301 = address line 1
 *   <li>N302 = address line 2
 * </ul>
 */
@Getter
abstract class N3Segment extends Segment {
