...
/**
 * Represents the GE (Functional Group Trailer) segment in the X12 834 (005010X220A1) format.
 *
 * <p>This segment marks the end of a functional group opened by a {@code GSSegment} and reconciles
 * it via the transaction-set count and matching group control number.
 *
 * <p>Element/position map:
 *
 * <ul>
 *   <li>GE01 = number of transaction sets included in the group
 *   <li>GE02 = group control number (must match the GS06 of the paired GS segment)
 * </ul>
 */
@Getter
abstract class GESegment extends Segment {
