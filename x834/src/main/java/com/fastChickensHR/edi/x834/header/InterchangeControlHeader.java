 ...
 * (005010X220A1). The ISA is the outermost segment of the interchange envelope and is paired with
 * the closing IEA. Extends the generic ISA segment with X834-specific defaults.
 */
@Getter
class InterchangeControlHeader extends ISASegment {
  ...
  /**
   * Default ISA01 authorization information qualifier {@code "00"} (No authorization information
   * present).
   */
  public static final AuthorizationInformationQualifier DEFAULT_AUTHORIZATION_INFO_QUALIFIER =
      AuthorizationInformationQualifier.fromString("00");
   ...
   */
  public static final SecurityInformationQualifier DEFAULT_SECURITY_INFO_QUALIFIER =
      SecurityInformationQualifier.fromString("00");
  ...
  /**
   * Default ISA05 interchange sender ID qualifier {@code "30"} (U.S. Federal Tax Identification
   * Number).
   */
  public static final InterchangeIdQualifier DEFAULT_INTERCHANGE_SENDER_QUALIFIER =
      InterchangeIdQualifier.fromString("30");

  /** Default ISA07 interchange receiver ID qualifier {@code "ZZ"} (Mutually Defined). */
  public static final InterchangeIdQualifier DEFAULT_INTERCHANGE_RECEIVER_QUALIFIER =
      InterchangeIdQualifier.fromString("ZZ");
  ...
  public static final InterchangeControlVersionNumber DEFAULT_INTERCHANGE_CONTROL_VERSION =
      InterchangeControlVersionNumber.fromString("00501");

  /**
   * Default ISA14 acknowledgment requested flag {@code "0"} (No interchange acknowledgment
   * requested).
   */
  public static final AcknowledgmentRequested DEFAULT_ACKNOWLEDGMENT_REQUESTED =
      AcknowledgmentRequested.fromString("0");

  /** Default ISA15 usage indicator {@code "T"} (Test). */
  public static final InterchangeUsageIndicator DEFAULT_USAGE_INDICATOR =
      InterchangeUsageIndicator.fromString("T");
  ...
  public static class Builder extends ISASegment.AbstractBuilder<Builder> {
    ...
    public Builder(X834Context context) {
      ...
      this.isa05 =
          context.getSenderIdQualifier() == null || context.getSenderIdQualifier().isBlank()
      ...
      this.isa07 =
          context.getReceiverIdQualifier() == null || context.getReceiverIdQualifier().isBlank()
      ...
      this.isa09 = DateFormat.D6.format(context.getDocumentDate());
      ...
      this.isa14 =
          (context.getAcknowledgmentRequested() != null
                  && !context.getAcknowledgmentRequested().isBlank())
