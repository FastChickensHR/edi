...
/**
 * Enumeration representing Individual Relationship Codes used in the INS02 field of the EDI 834
 * Member Level Detail (INS) segment.
 */
@Getter
public enum IndividualRelationshipCode implements EdiCodeEnum {
  ...
  /**
   * Gets an IndividualRelationshipCode instance from any input string. Matches against codes,
