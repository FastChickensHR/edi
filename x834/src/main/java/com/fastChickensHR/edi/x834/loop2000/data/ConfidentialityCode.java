...
/**
 * Enumeration representing Confidentiality Codes (X12 element 1165) emitted at the INS13 field of
 * the EDI 834 transaction.
 *
 * <p>Element 1165 defines exactly three codes: {@code O}, {@code R}, {@code U}. The former list
 * carried six invented codes ({@code C}, {@code V}, {@code N}, {@code L}, {@code M}, {@code H}) and
 * was missing {@code O}; both have been corrected.
 */
@Getter
public enum ConfidentialityCode implements EdiCodeEnum {
  ...
  /**
   * Gets a ConfidentialityCode instance from any input string. Matches against codes, names,
