...
class GESegmentTest {
  ...
  void testConstructionAndGetters() throws ValidationException {
    ...
    TestGESegment segment =
        TestGESegment.builder()
  ...
  void testSegmentIdentifier() throws ValidationException {
    TestGESegment segment = TestGESegment.builder().setGe01("3").setGe02("54321").build();
  ...
  void testBuilderMethodChaining() throws ValidationException {
    TestGESegment segment = TestGESegment.builder().setGe01("15").setGe02("11111").build();
  ...
  void testNullValues() throws ValidationException {
    TestGESegment segment = TestGESegment.builder().build();
