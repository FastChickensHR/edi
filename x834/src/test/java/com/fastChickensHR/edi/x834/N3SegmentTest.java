...
class N3SegmentTest {
  ...
  void testGetSegmentIdentifierReturnsExpectedValue() throws ValidationException {
    TestN3Segment segment = TestN3Segment.builder().setAddressLine1(addressLine1).build();
    assertEquals("N3", segment.getSegmentIdentifier());
  }

  @Test
  void testSettingSpecNamesGettingDomainNames() throws ValidationException {
    TestN3Segment.Builder builder =
        TestN3Segment.builder().setN301(addressLine1).setN302(addressLine2);
  ...
  void testSettingDomainNamesGettingSpecNames() throws ValidationException {
    TestN3Segment segment =
        TestN3Segment.builder().setAddressLine1(addressLine1).setAddressLine2(addressLine2).build();
  ...
  void testBuilderMethodsUsingSpecNames() throws ValidationException {
    TestN3Segment segment =
        TestN3Segment.builder().setN301(addressLine1).setN302(addressLine2).build();
  ...
  void testEmptyAddressLine2() throws ValidationException {
    TestN3Segment segment =
        TestN3Segment.builder().setAddressLine1(addressLine1).setAddressLine2("").build();
