...
class RefSegmentTest {
  ...
  void testCreation_UsingDirectSetters_ShouldCreateSegment() throws ValidationException {
    // Arrange & Act
    RefSegment segment = new RefSegment.Builder().setRef01("ZZ").setRef02("ABC123").build();
  ...
  @NullAndEmptySource
  @ValueSource(strings = {"   ", "\t"})
  void testValidation_InvalidReferenceIdentificationQualifier_ShouldThrowException(
      String invalidValue) {
    RefSegment.Builder builder = new RefSegment.Builder().setReferenceIdentification("12345");

    IllegalArgumentException exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> builder.setReferenceIdentificationQualifier(invalidValue));
  ...
  void testSetterAliases_ShouldSetCorrectFields() throws ValidationException {
    RefSegment segment1 = new RefSegment.Builder().setRef01("38").setRef02("9876").build();
