...
class TransactionSetIdentifierCodeTest {
  ...
  private static Stream<Arguments> aliases() {
    return Stream.of(
        Arguments.of(
            "benefit enrollment", TransactionSetIdentifierCode.BENEFIT_ENROLLMENT_AND_MAINTENANCE),
  ...
  void rejectsNullEmptyAndUnknown(String input) {
    assertThrows(
        IllegalArgumentException.class, () -> TransactionSetIdentifierCode.fromString(input));
  }
}
