...
class ISASegmentTest {
  ...
  private static final AuthorizationInformationQualifier VALID_ISA01 =
      AuthorizationInformationQualifier.fromString("00");
  private static final String VALID_ISA02 = "          ";
  private static final SecurityInformationQualifier VALID_ISA03 =
  ...
  private static final InterchangeControlVersionNumber VALID_ISA12 =
      InterchangeControlVersionNumber.fromString("00501");
  private static final String VALID_ISA13 = "000000001";
  private static final AcknowledgmentRequested VALID_ISA14 =
      AcknowledgmentRequested.fromString("0");
  private static final InterchangeUsageIndicator VALID_ISA15 =
      InterchangeUsageIndicator.fromString("P");
  ...
  /**
   * Render golden: the fixed-width ISA interchange header. The builder right-pads ISA06/ISA08 to 15
   * characters (see the trailing spaces after the sender/receiver IDs), so this whole-string
  ...
  void rendersFixedWidthIsaSegment() throws ValidationException {
    ...
    String expected =
        "ISA*00*          *00*          *30*SENDER123456   *ZZ*RECEIVER123456 *230630*1200*^*00501*000000001*0*P*:~\n";
  ...
  void testRequiredFieldsValidation(Supplier<Exception> exceptionSupplier) {
    ...
    assertTrue(
        ...
        "Exception should be either ValidationException or IllegalArgumentException, but got: "
  ...
  void testFormattingValidation() throws ValidationException {
    ...
    ValidationException icnException =
        assertThrows(ValidationException.class, invalidIcnBuilder::build);
    assertTrue(
        icnException.getMessage().contains("Interchange Control Number"),
    ...
    ValidationException separatorException =
        assertThrows(ValidationException.class, invalidSeparatorBuilder::build);
    assertTrue(
        separatorException.getMessage().contains("Component Element Separator"),
