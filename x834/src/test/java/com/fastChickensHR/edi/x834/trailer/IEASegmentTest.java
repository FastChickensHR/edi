...
class IEASegmentTest {
  ...
  void testSegmentIdentifier() throws ValidationException {
    TestIEASegment segment = TestIEASegment.builder().setIea01("2").setIea02("000054321").build();
  ...
  /**
   * Render golden for the IEA interchange trailer: {@code
   * IEA*<groupCount>*<interchangeControlNumber>~}. Whole-string equality pins the element order and
   * terminator that a {@code getElementValues()} array check leaves unrendered. Delimiters come
  ...
  void testBuilderMethodChaining() throws ValidationException {
    TestIEASegment segment = TestIEASegment.builder().setIea01("7").setIea02("000011111").build();
  ...
  void testBlankIea01ThrowsValidationException() {
    assertThrows(
        ValidationException.class, () -> TestIEASegment.builder().setIea02("000000001").build());
  }

  @Test
  void testBlankIea02ThrowsValidationException() {
    assertThrows(ValidationException.class, () -> TestIEASegment.builder().setIea01("1").build());
  }

  @Test
  void testBothFieldsNullThrowsValidationException() {
    assertThrows(ValidationException.class, () -> TestIEASegment.builder().build());
  }
}
