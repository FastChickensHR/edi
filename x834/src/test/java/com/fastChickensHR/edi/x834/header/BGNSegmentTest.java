...
class BGNSegmentTest {
  ...
  /**
   * Tests for getSegmentIdentifier method in BGNSegment class. This method is expected to always
   * return the constant value "BGN".
   */
  @Test
  ...
  void testSettingSpecNamesGettingDomainNames() throws ValidationException {
    ...
    BGNSegmentImpl segment =
        new BGNSegmentImpl.Builder()
            .setBgn01("00")
            .setBgn02("12345")
            .setBgn03("20250101")
            .setBgn04("1200")
  ...
  void testGetElementValues() throws ValidationException {
    BGNSegmentImpl segment = createValidSegment();
    String[] expected = {"00", "12345", "20250101", "1200", "ET", "ORIGREF123", "T1", "A1", "ZZ"};
  ...
  void testGetElementValuesWithNullValues() throws ValidationException {
    BGNSegmentImpl segment =
        new BGNSegmentImpl.Builder().setBgn01("00").setBgn02("12345").setBgn03("20250101").build();
  ...
  void testInvalidBgn01_ShouldThrowValidationException(String invalidValue) {
    ...
    assertTrue(
        exception.getMessage().contains("Input cannot be null or empty"),
        "Exception message should mention BGN01");
  }
  ...
  void testInvalidBgn02_ShouldThrowValidationException(String invalidValue) {
    BGNSegmentImpl.Builder builder =
        new BGNSegmentImpl.Builder().setBgn01("00").setBgn02(invalidValue).setBgn03("20250101");

    ValidationException exception = assertThrows(ValidationException.class, builder::build);
    assertTrue(
        exception.getMessage().contains("BGN02"),
  ...
  void testInvalidBgn03_ShouldThrowValidationException(String invalidValue) {
    BGNSegmentImpl.Builder builder =
        new BGNSegmentImpl.Builder().setBgn01("00").setBgn02("12345").setBgn03(invalidValue);

    ValidationException exception = assertThrows(ValidationException.class, builder::build);
    assertTrue(
        exception.getMessage().contains("BGN03"),
  ...
  void testBgn02ExceedingMaxLength_ShouldThrow() {
    ...
    BGNSegmentImpl.Builder builder =
        new BGNSegmentImpl.Builder().setBgn01("00").setBgn02(tooLong).setBgn03("20250101");
  ...
  void testBgn03WrongLength_ShouldThrow() {
    BGNSegmentImpl.Builder builder =
        new BGNSegmentImpl.Builder().setBgn01("00").setBgn02("12345").setBgn03("2025");
  ...
  void testBgn03NonNumeric_ShouldThrow() {
    BGNSegmentImpl.Builder builder =
        new BGNSegmentImpl.Builder().setBgn01("00").setBgn02("12345").setBgn03("2025AB01");
  ...
  void testBgn01Missing_ShouldThrow() {
    BGNSegmentImpl.Builder builder =
        new BGNSegmentImpl.Builder().setBgn02("12345").setBgn03("20250101");
  ...
  /**
   * Tests that the optional fields (BGN04-BGN09) don't cause validation exceptions when not
   * provided.
   */
  @Test
