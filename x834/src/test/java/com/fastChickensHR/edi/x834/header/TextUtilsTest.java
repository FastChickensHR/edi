...
class TextUtilsTest {
  ...
  /**
   * Class under test: TextUtils Method under test: spaces(int count)
   *
   * <p>This method generates a string consisting of a specified number of spaces. Throws
  ...
  void testSpacesWithValidCount() {
    ...
    assertEquals(
        expected, result, "The method should return a string with the specified count of spaces.");
  }
