...
class HealthCoverageDateQualifierTest {
  ...
  private static Stream<Arguments> aliases() {
    return Stream.of(
        ...
        Arguments.of(
            "consolidated omnibus budget reconciliation act start",
            HealthCoverageDateQualifier.COBRA_BEGIN),
        ...
        Arguments.of(
            "consolidated omnibus budget reconciliation act end",
            HealthCoverageDateQualifier.COBRA_END),
  ...
  void rejectsNullEmptyAndUnknown(String input) {
    assertThrows(
        IllegalArgumentException.class, () -> HealthCoverageDateQualifier.fromString(input));
  }
}
