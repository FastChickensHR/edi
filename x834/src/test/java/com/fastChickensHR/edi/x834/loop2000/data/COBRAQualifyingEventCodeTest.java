...
class COBRAQualifyingEventCodeTest {
  ...
  private static Stream<Arguments> aliases() {
    return Stream.of(
        ...
        Arguments.of("reduced hours", COBRAQualifyingEventCode.REDUCTION_OF_WORK_HOURS),
        Arguments.of("reduction in hours", COBRAQualifyingEventCode.REDUCTION_OF_WORK_HOURS),
        Arguments.of("parttime", COBRAQualifyingEventCode.REDUCTION_OF_WORK_HOURS),
        Arguments.of("deceased", COBRAQualifyingEventCode.DEATH),
        Arguments.of("passed away", COBRAQualifyingEventCode.DEATH),
        Arguments.of("legal separation", COBRAQualifyingEventCode.SEPARATION),
        Arguments.of("aged out", COBRAQualifyingEventCode.INELIGIBLE_CHILD),
        Arguments.of("no longer dependent", COBRAQualifyingEventCode.INELIGIBLE_CHILD),
        Arguments.of("dependent child ceases", COBRAQualifyingEventCode.INELIGIBLE_CHILD),
