...
class MemberResidenceStreetAddressTest {
  ...
  void testCreateWithAddressLine1Only() throws ValidationException {
    ...
    MemberResidenceStreetAddress address =
        MemberResidenceStreetAddress.builder().setAddressLine1(addressLine1).build();
  ...
  void testCreateWithDirectN3ElementSetters() throws ValidationException {
    ...
    MemberResidenceStreetAddress address =
        MemberResidenceStreetAddress.builder().setN301(addressLine1).setN302(addressLine2).build();
  ...
  void testSegmentIdentifier() throws ValidationException {
    MemberResidenceStreetAddress address =
        MemberResidenceStreetAddress.builder().setAddressLine1("123 Main Street").build();
