...
class MemberNameTest {
  ...
  void testSettingSpecNamesGettingDomainNames() throws ValidationException {
    MemberName.Builder builder =
        MemberName.builder()
            ...
            .setIdentificationCodeQualifier(idCodeQualifier)
  ...
  void testOverridingDefaultValues() throws ValidationException {
    ...
    MemberName memberName =
        MemberName.builder()
            .setEntityIdentifierCode(customEntityIdentifierCode)
            .setEntityTypeQualifier(entityType)
            .setLastName(lastName)
            .build();
  ...
  void testPersonRequiresLastName() {
    ValidationException exception =
        assertThrows(
            ValidationException.class, () -> MemberName.builder().setFirstName(firstName).build());
    ...
    ValidationException exception =
        assertThrows(
            ...
            () ->
                MemberName.builder()
                    .setLastName(lastName)
                    .setIdentificationCodeQualifier("34")
                    .build());
  ...
  void testRender() throws ValidationException {
    ...
    assertEquals(
        "NM1*IL*1*DOE*JOHN*Q*MR*JR*34*123456789~",
        segment.render().trim(),
