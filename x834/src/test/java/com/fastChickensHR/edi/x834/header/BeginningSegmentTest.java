...
class BeginningSegmentTest {
  ...
  /**
   * Tests for getSegmentIdentifier method in BeginningSegment class. This method is expected to
   * always return the constant value "BGN".
   */
  @Test
  ...
  void testSettingSpecNamesGettingDomainNames() throws ValidationException {
    ...
    BeginningSegment segment =
        new BeginningSegmentImpl.Builder(context)
  ...
  void testDefaultValues() throws ValidationException {
    BeginningSegment segment =
        new BeginningSegmentImpl.Builder(context).setBgn02("REF123").setBgn03("20230101").build();

    assertEquals(
        BeginningSegment.DEFAULT_TRANSACTION_SET_PURPOSE_CODE, segment.getBgn01().getCode());
  }
  ...
  void testInvalidBgn01_ShouldThrowValidationException(String invalidValue) {
    BeginningSegment.Builder builder =
        new BeginningSegmentImpl.Builder(context).setBgn02("REF123").setBgn03("20230101");
