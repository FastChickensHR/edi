...
class MemberCommunicationsNumbersTest {
    ...
    PERSegment per =
        MemberCommunicationsNumbers.builder()
            .addCommunicationNumber(
                CommunicationNumberQualifier.ELECTRONIC_MAIL, "jane@example.com")
            .addCommunicationNumber(CommunicationNumberQualifier.HOME_PHONE, "5551234567")
  ...
  void rejectsAFourthChannelRatherThanDroppingIt() throws ValidationException {
    MemberCommunicationsNumbers.Builder per =
        MemberCommunicationsNumbers.builder()
            .addCommunicationNumber(
                CommunicationNumberQualifier.ELECTRONIC_MAIL, "jane@example.com")
            .addCommunicationNumber(CommunicationNumberQualifier.HOME_PHONE, "5551234567")
    ...
    ValidationException ex =
        assertThrows(
            ...
            () ->
                per.addCommunicationNumber(
                    CommunicationNumberQualifier.CELLULAR_PHONE, "5550000000"));
  ...
  void rejectsAPerCarryingNoChannelAtAll() {
    ValidationException ex =
        assertThrows(
            ValidationException.class, () -> MemberCommunicationsNumbers.builder().build());
