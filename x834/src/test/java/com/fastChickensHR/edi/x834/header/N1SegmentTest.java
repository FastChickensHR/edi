...
class N1SegmentTest {
  ...
  void testSegmentIdentifier() throws ValidationException {
    TestN1Segment segment =
        new TestN1Segment.Builder().setN101(entityCode).setN102("fake name").build();
  ...
  void testDomainGetters() throws ValidationException {
    ...
    assertEquals(
        ...
        "getEntityIdentifierCode should return the correct value");
    assertEquals(
        name, segment.getPlanSponsorName(), "getPlanSponsorName should return the correct value");
    assertEquals(
        qualifier,
        segment.getIdentificationCodeQualifier().getCode(),
        "getIdentificationCodeQualifier should return the correct value");
    assertEquals(
        identifier,
        segment.getSponsorIdentifier(),
        "getSponsorIdentifier should return the correct value");
  }
  ...
  void testRender() throws ValidationException {
    ...
    assertEquals(
        "N1*01*Test Name*PB*123456~",
        segment.render().trim(),
        "Render should properly format the segment");
  }
  ...
  void testRenderWithOnlyNameDoesNotNpeOnMissingN103() throws ValidationException {
    ...
    TestN1Segment segment =
        new TestN1Segment.Builder().setN101(entityCode).setN102("Sponsor Only").build();
