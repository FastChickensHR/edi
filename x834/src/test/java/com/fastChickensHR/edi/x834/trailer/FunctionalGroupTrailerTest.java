...
class FunctionalGroupTrailerTest {
  ...
  void testUsageInGroupContext() throws ValidationException {
    FunctionalGroupTrailer trailer =
  ...
  /**
   * Render golden: the Functional Group Trailer renders as its underlying GE segment, {@code
   * GE*<count>*<groupControlNumber>~}. Whole-string equality pins the segment id, element order,
   * and terminator that the getter/{@code getElementValues()} echo left unrendered. Delimiters come
